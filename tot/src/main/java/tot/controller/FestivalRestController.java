...
public class FestivalRestController {
	...
	public ResponseEntity<List<FestivalDTO>> getFestivals(@RequestParam(required = false) String month,
			@RequestParam String areacode, @RequestParam(required = false) String tripStartDate,
